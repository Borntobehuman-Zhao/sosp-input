...
<%
	...
	String report = request.getParameter( "__rpg" );
	String rpxHome = request.getParameter( "__rpxHome" );
	String dfxHome = request.getParameter( "__dfxHome" );
	Context.getInitCtx().setMainDir( rpxHome );
	Env.setMainPath( dfxHome );
	try {
		String argRpx = request.getParameter( "__arg" );
%>
...
<script language="javascript">
	var rpxHome = encodeURIComponent("<%=rpxHome%>");
