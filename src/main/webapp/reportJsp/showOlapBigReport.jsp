...
String rpxf = (String)session.getAttribute(reportId+"_REPORT_FILE");
...
<%
	...
	String report = rpxf;//request.getParameter( "rpx" );
	String rpxHome = "";//"E%3A%2Fprograms%2Fraqsoft20200902%2Freport%2Fweb%2Fwebapps%2Fdemo%2FWEB-INF%2FreportFiles%2F10基本报表";//request.getParameter( "rpxHome" );
...
<script language="javascript">
	...
	try {
		$(document).ready(function(){
			$('.flashprint2').parent().parent().remove();
		});
	}catch(e){}
</script>
