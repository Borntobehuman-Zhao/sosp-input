...
String inputFileTableName = request.getParameter( "inputFileTableName" );
if (inputFileTableName == null) inputFileTableName = "";
String noFile = "";
...
<script>
guideConf.inputFileTableName = "<%=inputFileTableName%>";
