...
<head>
	...
	<script type="text/javascript" src="<%=guideDir %>js/dqlApi.js"></script>
	...
	<%}else{%>
	<script type="text/javascript" src="<%=guideDir %>js/query.js"></script>
	<script type="text/javascript" src="<%=guideDir %>js/dqlreport.js"></script>
	<%}%>
