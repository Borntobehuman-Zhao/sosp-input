...
var aly = {
	...
	,refresh : function(noCalc, noRefreshDialog, drillRpx, noAggr, zongji) {
		...
		for (var i=rqAnalyse.rpxs.length-1; i>=0; i--) {
			...
			//名字过长变成...
			confsDiv.append("<div style='padding:5px;cursor:pointer;"+sty+"' confName='"+confi.name+"'><img style='vertical-align:-2px;cursor: pointer;' lock=1 src='"+contextPath+(guideConf.guideDir+(confi.autoCalc==1?"/img/guide/17.png":"/img/guide/18.png"))+"'><span style='padding:0 20px 0 5px;vertical-align:1px;width:123px;overflow:hidden;display:inline-block;text-overflow:ellipsis;'><nobr>"+confi.name+"</nobr></span><img style='float:right;vertical-align:-2px;cursor:pointer;margin:0 5px;' del=1 src='"+contextPath+guideConf.guideDir+"/img/guide/13.png'><img modify=1 style='vertical-align:-2px;cursor:pointer;margin:0 5px;float:right;' src='"+contextPath+guideConf.guideDir+"/img/guide/31.png'></div>")
