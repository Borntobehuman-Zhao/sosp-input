...
<script type="text/javascript" src="<%=guideDir %>/dbd2.0/js/preview.js"></script>
...
<div class="container-fluid">
 <div class="row-fluid">
    ...
    <div class="span12 dbd-center" style="background-image: none!important;">
      <!--Body content-->
      <!-- <div class="main">
      ...
      <div class="main2" id="mobileViewMain" style="display:none">
      	<div id=mimg style="height: 100%;width: 450px;padding-top: 40px;padding-left: 45px;padding-right: 45px;padding-bottom:90px;margin: auto;">
			<iframe height="620px" width="350px" id="mframe" style="">
			</iframe>
      	</div>
		</div>
    </div>
...
function saveDBD(){
	setViewMode(1)
	//var sd = guideConf.saveDisp;
	//guideConf.saveDisp = "1011";
	saveOlap();
	//guideConf.saveDisp = sd;
