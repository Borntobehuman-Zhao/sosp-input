...
<link href="<%=guideDir %>dbd2.0/css/bootstrap/bootstrap.css" rel="stylesheet" media="screen">
<link href="<%=guideDir %>dbd2.0/css/bootstrap/bootstrap-responsive.css" rel="stylesheet" media="screen">
...
<link  rel="stylesheet" href="<%=guideDir %>dbd2.0/css/DBD.css"/>
<link  rel="stylesheet" href="<%=guideDir %>dbd2.0/css/style.css"/>
...
<raqsoft:dashboard
	dbd="<%=dbd %>"
></raqsoft:dashboard>
<script type="text/javascript" src="<%=guideDir %>/dbd2.0/js/dashboard.js?v=<%=v %>"></script> 
...
<script type="text/javascript" src="<%=guideDir %>/dbd2.0/js/dqlApi_d2.js?v=<%=v %>"></script>
<script type="text/javascript" src="<%=guideDir %>/dbd2.0/js/where_d2.js?v=<%=v %>"></script>
<script type="text/javascript" src="<%=guideDir %>/dbd2.0/js/query_d2.js?v=<%=v %>"></script>
<script type="text/javascript" src="<%=guideDir %>/dbd2.0/js/dqlreport_d2.js?v=<%=v %>"></script>
...
<div class="container-fluid" style="padding-left:0px">
 <div class="row-fluid">
    <div class="span12 dbd-center" style="background-image: none!important;height:0px">
      <!--Body content-->
      <!-- <div class="main">
      ...
      <div class="main container-fluid row-fluid gridster" style="background-color: white;padding-bottom: 20px;">
...
//$("#logopic").css("width",(parseInt($('.side').css("width"))+30)+"px").css("background-color","rgb(80, 164, 237)");
...
function goback(){
	window.location = "./index.jsp?currFolderId="+currFolderId+"&currLevel="+currLevel;
}
