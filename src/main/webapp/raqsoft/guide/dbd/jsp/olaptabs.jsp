...
<script type="text/javascript" src="<%=guideDir %>/dbd/js/olaptabs.js?v=<%=v %>"></script>
...
<div class="container-fluid" id="dataHeader" style="background-color:#f3f3f3">
	<nav class="navbar" role="navigation">
		<ul class="nav navbar-nav">
			...
			<!-- <li class="dropdown">
				<a class="navFont-default2" href="#" class="dropdown-toggle" data-toggle="dropdown">
					样式
					<b class="caret"></b>
				</a>
				<ul class="dropdown-menu">
					<li class="dropdown-submenu">
						...
						<ul class="dropdown-menu">
							<li><a href="javascript:showColorBoard(0);" style="">纯色背景</a></li>
					...
					<li class="dropdown-submenu">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="javascript:switchShowTitle();" style="">隐藏标题</a><div style="display:none">对勾</div></li>true\false 对勾
