...
//				}
//			}
			if(layout.dbdversion && layout.dbdversion.indexOf("2") == 0){
				alert("该版本olap文件可能打开不正确："+layout.dbdversion);
				dbdInit();
			}else dbdInit(layout);
