...
<div class="layui-layout">
    ...
    <div id="rightSideMengban" class="layui-body" style="display:none;left:300px;top:60px;overflow-y:hidden;background:white;position:fixed">
	    <table width=100% height=100%>
			<tr><td width=100% style="text-align:center;vertical-align:middle"><br>加载中......</td></tr>
		</table>
    </div>
</div>
<script>
