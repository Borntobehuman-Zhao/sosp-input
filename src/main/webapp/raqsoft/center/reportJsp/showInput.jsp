...
<%
	...
	com.raqsoft.report.usermodel.Context session_ctx = null;
	if(sessionCtx != null) session_ctx = (com.raqsoft.report.usermodel.Context) sessionCtx;
	com.raqsoft.report.usermodel.Context ctx = new com.raqsoft.report.usermodel.Context(session_ctx);
	
	Object sessionCtxDM =  session.getAttribute("user_report_context_dm");
	com.raqsoft.dm.Context session_ctx_dm = null;
	if(sessionCtx != null) session_ctx_dm = (com.raqsoft.dm.Context) sessionCtxDM;
	com.raqsoft.dm.Context ctx_dm = new com.raqsoft.dm.Context(session_ctx_dm);
	session.setAttribute("center_context", ctx);
	session.setAttribute("center_input_context", ctx_dm);
