  ...
  <ul class="left">
    ...
    <li class="toggleBg borderRight">
      <ul class="fileOper">
		...
		<li id="inputAppendExcel" style="display:none;"><a class="ICOhover" href="#" onClick="_inputAppendExcelData('<%=sgid %>');return false;"><span title="<%=InputMessage.get(request).getMessage("input.web16")%>" class="excel-append"></span></a></li>
