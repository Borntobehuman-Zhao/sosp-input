...
<%
	...
	Context ctx_param = new Context(session_ctx);
	com.raqsoft.center.Config config1 = com.raqsoft.center.Center.getConfig();
	...
	param.append(params);
	String resultPage = "queryReport.jsp?rpx=" + URLEncoder.encode( report, "UTF-8" ) + "&scroll=" + scroll+"&contextName=curr_context";
		...
		<div data-options="region:'north',border:false"><center>
			<table id="param_tbl" align=center><tr><td>
				<report:param name="form1" paramFileName="<%=paramFile%>"
					...
					needImportEasyui="no"
					contextName="curr_context_param"
