...
<% 
	...
	//2017.10.13 by hdw
	Context ctxobj = (Context) session.getAttribute("user_report_context");
	...
	if(paramNames!=null){
		while(paramNames.hasMoreElements()){
			...
			if(ctxobj.getParamValue(paramName) != null){
				ctxobj.setParamValue(paramName,paramValue);
			}
...
<report:html name="report1" reportFileName="<%=report%>"
	funcBarLocation="no"
	needScroll="<%=scroll%>"
	contextName="user_report_context"
	scrollWidth="100%" 
	scrollHeight="100%"
	needImportEasyui="no"
