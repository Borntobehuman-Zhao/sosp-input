			...
			<div align="center">
				...
				<TABLE align=center class="layui-table" style="table-layout: fixed; BORDER-COLLAPSE: collapse;width:350px">
					...
					<tr class="">
						<td><span>邮箱</span></td>
						<td>
							<input autocomplete="off" class="layui-input" type="text" lay-verify="email" name='email' id="email" value="${userObj.email}"/>
						</td>
					</tr>
					...
					<tr class="">
						<td><span>电话</span></td>
						<td>
							<input autocomplete="off" class="layui-input" type="text" lay-verify="required|phone" name="phone" id="phone" value="${userObj.phone}"/>
						</td>
					</tr>
					</c:if>
					<tr class="">
