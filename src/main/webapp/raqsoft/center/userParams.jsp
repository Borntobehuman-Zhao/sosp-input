...
function form_submit(){
	...
	$.ajax({
		...
		success:function(){
			alert("保存成功");
			window.location="<%=contextPath%>/reportCenterServlet?action=85&userId="+userId;
		}
	});
}
...
<body>
	<div align="center" class="layui" style="margin-top:20px"><%=request.getAttribute("userName") %>用户参数修改</div>
	<br>
	<div align="center">
