...
<%@ page isELIgnored="false" %> 
 <%
    	String contextPath = request.getContextPath();
 		...
 		AbstractDefaultUserManager userManager = Center.getUserManager();
...
<script type="text/javascript">
			...
			function showExtra(event){
				...
				case 1 :
					filedom.attr('accept','.rpx,.rpg,.sht');break;
				case 2 :
					filedom.attr('accept','.rpx');break;
				case 3:
					filedom.attr('accept','.qyx');break;
				case 4:
					filedom.attr('accept','.dct');break;
				case 5:
					filedom.attr('accept','.vsb');break;
				case 6:
				case 12:
					filedom.attr('accept','.bin,.json');break;
				case 7:
					filedom.attr('accept','.txt,.xlsx,.xls,.csv,.ctx,.btx');break;
				case 8:
				case 81:
					filedom.attr('accept','.dfx');break;
				case 10: 
				case 11:
					filedom.attr('accept','.sht');break;
				case 13:
					filedom.attr('accept','.olap');break;
				case 9:
					filedom.removeAttr('accept');break;
				}
			}
