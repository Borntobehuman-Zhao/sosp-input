				...
				<tr class="export">
					...
					<td>
						<div class="layui-form-item">
						      ...
						      <input class="" value="content" name="content" title="正文" type="checkbox" lay-skin="primary"/>
						</div>
					</td>
				</tr>
				<tr class="timer">
...
function getUserParams(){
	...
	for(var i = 0 ; i < userIdArr.length; i++){
		...
		if( params != null && params != "") s.push(params);
	}
	return s;
}
